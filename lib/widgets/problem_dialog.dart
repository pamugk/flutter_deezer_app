...
Future<void> problemDialogBuilder(
                ...
                children: <Widget>[
                  FormField<bool>(
                    builder: (state) => CheckboxListTile(
                      ...
                      title: Text(AppLocalizations.of(context)!.problemArtist),
                      value: state.value!,
                    ),
                    initialValue: false,
                  ),
                  ...
                  FormField<bool>(
                    builder: (state) => CheckboxListTile(
                      onChanged: state.didChange,
                      title:
                          Text(AppLocalizations.of(context)!.problemSuspicious),
                      value: state.value!,
                    ),
                    initialValue: false,
                  ),
                  ...
                  TextField(
                    decoration: InputDecoration(
                        hintText:
                            AppLocalizations.of(context)!.problemOtherComment),
                    enabled: false,
                  ),
                ]),
          ),
