    ...
    child: Column(mainAxisSize: MainAxisSize.min, children: <Widget>[
                  Stack(
                    ...
                    children: [
                      ...
                      height: 250.0, opacity: AlwaysStoppedAnimation(active ? 0.75 : 1.0), width: 250.0),
                    ]),
                      Row(
                        children: [
                          Material(
                                      ...
                                      child: ListTile(
                                          ...
                                          onTap: () {
                                            Navigator.pushNamed(
                                              context,
                                              '/user',
                                              arguments: widget.playlist.user!.id);
                                          },
                  ...
                  Tooltip(
                    ...
                    child: Text(widget.playlist.title, overflow: TextOverflow.ellipsis)
                  ),
